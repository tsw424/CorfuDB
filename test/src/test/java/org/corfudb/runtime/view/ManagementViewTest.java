...
public class ManagementViewTest extends AbstractViewTest {
    ...
    public void xyz() throws Exception {
        ...
        corfuRuntime.getRouter(SERVERS.ENDPOINT_0).getClient(ManagementClient.class).addNodeRequest(
                SERVERS.ENDPOINT_1, true, true, true, false, 0);
        ...
        Layout expectedLayout1 = new TestLayoutBuilder()
                ...
                .addToLayout()
                .build();
        assertThat(corfuRuntime.getLayoutView().getLayout()).isEqualTo(expectedLayout1);
        ...
        Layout expectedLayout2 = new TestLayoutBuilder()
                .setEpoch(2L)
                .addLayoutServer(SERVERS.PORT_0)
                .addLayoutServer(SERVERS.PORT_1)
                .addSequencer(SERVERS.PORT_0)
                ...
                .addToLayout()
                .build();
        assertThat(corfuRuntime.getLayoutView().getLayout()).isEqualTo(expectedLayout2);
    }
}
